...
var USER_CARDS_URI = 'index.php?mainPage=browseUserProducts&idCategory=1&idUser=813616&resultsPage=';
...
function openProductsPage(userCards, closeCb, pageNum) {
  ...
  page.onClosing = function close(page) {
    // doWhilst callback, the first argument is an optional error, 
    // the second is passed to the hasNext test function
    closeCb(null, page);
  };
